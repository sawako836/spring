...
<!-- 사용자 등록 -->			<a href="${cp }/user/userForm" class="btn btn-default pull-right">사용자 등록</a>
						...
						<div class="text-center">
								...
								<c:choose>
							    	...
							    	<c:otherwise>
										<li class=""> <!-- pagination << 화살표 -->
											<a href="${cp }/user/userPagingList?page=${pageVo.page-1}">
											<span aria-hidden="true">&laquo;</span>
											</a>
							    		</li>
									</c:otherwise>
							...
							<c:forEach begin="1" end="${paginationSize}" var="page">
							    ...
							    <c:choose>
						    		...
						    		<c:otherwise>
									<li class=""> <!-- pagination << 화살표 -->
										<a aria-label="Next" href="${cp }/user/userPagingList?page=${pageVo.page+1}">
										<span aria-hidden="true">&raquo;</span>
										</a>
						    		</li>
									</c:otherwise>
